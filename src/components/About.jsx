   ...
   return (
      <div  className="flex lg:flex-row flex-col lg:items-start items-center">
         ...
         <div className="flex flex-col lg:text-lg md:text-md text-sm lg:w-2/3 w-full gap-6 items-center justify-end">
            <p className='w-3/4'>
               Hi and welcome! My name is Kenny, and I am a recent Cognitive Systems graduate from the University of British Columbia.
            ...
            <p className='w-3/4'>
               I am a hard worker that wants to find solutions to problems that makes
