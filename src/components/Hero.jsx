   ...
   return (
      <div id="top-page" className="flex lg:flex-row md:flex-row flex-col w-full h-full items-center lg:h-96 md:h-80 lg:mt-32 mt-10 text-gray-600">
         ...
         <div className="flex flex-col lg:w-1/2 md:w-1/2 w-full h-full p-4 pl-10 pt-12 text-left gap-4">
            ...
            {/* links */}
            <div className="flex flex-row items-center h-10 w-full gap-2">
               <Tooltip content="LinkedIn" placement="bottom">
                  <a href="https://www.linkedin.com/in/kenneth-averna-9ab182142" className="p-1">
               ...
               <Tooltip content="GitHub" placement="bottom">
                  <a href="https://www.github.com/kennyav" className="p-1">
               ...
               <Tooltip content="Email Me" placement="bottom">
                  <a href="mailto: kenny.averna@icloud.com" className="p-1">
                     <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 512 512"><path d="M121 32C91.6 32 66 52 58.9 80.5L1.9 308.4C.6 313.5 0 318.7 0 323.9V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V323.9c0-5.2-.6-10.4-1.9-15.5l-57-227.9C446 52 420.4 32 391 32H121zm0 64H391l48 192H387.8c-12.1 0-23.2 6.8-28.6 17.7l-14.3 28.6c-5.4 10.8-16.5 17.7-28.6 17.7H195.8c-12.1 0-23.2-6.8-28.6-17.7l-14.3-28.6c-5.4-10.8-16.5-17.7-28.6-17.7H73L121 96z" /></svg>
                  </a>
               </Tooltip>
            </div>
         </div>
         ...
         <div className="flex justify-center items-center w-1/2 p-4">
            <img src="/bitmoji.png" alt="loading..." className="rounded-full" />
         </div>
